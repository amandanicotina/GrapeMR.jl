...
opt_params   = OptimizationParams(N, max_iter, cost_saturation_contrast, [true true false]);
grape_output = @time grape(opt_params, field_init, spins, lr_scheduler; max_iter = max_iter, ϵ=1e-3); 
