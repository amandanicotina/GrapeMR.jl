...
# Grape Parameters 
grape_params = GrapeParams(1000, :targetB0_steady_state, [true true false])
...
bohb_max_iter = range(1, stop=2, step=500)
bohb_Tc = LinRange(0.05, 1.0, 20)
bohb = hyperopt_grape(spins, grape_params, bohb_Tc, bohb_max_iter; i=1)
Tc, poly_start, poly_degree, max_iter =  bohb.minimizer # 0.5, 0.1, 1, 1000 #
